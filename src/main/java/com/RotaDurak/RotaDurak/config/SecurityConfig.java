...
import com.RotaDurak.RotaDurak.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/me").authenticated() // endpointler için yetkilendirme zorunlu   //sonra düzenlenecek bilgilerim sayfası eklenecek
